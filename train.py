...
parser.add_argument("--milestone", type=int, default= [30, 60, 90], help="When to decay learning rate; should be less than epochs")
...
def main():
    ...
    for epoch in range(opt.epochs):
        if epoch < opt.milestone[0]:
            current_lr = opt.lr
        elif epoch < opt.milestone[1]:
            current_lr = opt.lr / 5.
        elif epoch < opt.milestone[2]:
            current_lr = opt.lr / 25.
        else:
            current_lr = opt.lr / 125.
